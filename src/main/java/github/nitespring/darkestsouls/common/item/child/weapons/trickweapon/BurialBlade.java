...
public class BurialBlade extends TrickWeapon {
    public BurialBlade(Tier tier, float attack, float speed, float reach, float knockback, int poise, int posture, int blood, int poison, int frost, int rot, int death, int fire, int holy, int serrated, int durability, int enchantability, float movementSpeed, int maxTargets, Properties properties) {
    ...
    public Item getTransformedWeapon() {
        return ItemInit.BURIAL_BLADE_EXTENDED.get();
    }
