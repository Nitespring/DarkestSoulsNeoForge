...
public class FireStormParent extends FireStormEntity{


    public FireStormParent(EntityType<? extends AbstractHurtingProjectile> p_36833_, Level p_36834_) {
        super(p_36833_, p_36834_);
    }

    public FireStormParent(EntityType<? extends AbstractHurtingProjectile> p_310629_, double p_311590_, double p_312782_, double p_309484_, Level p_311660_) {
   ...
   /* public MagmaBurstParent(EntityType<? extends AbstractHurtingProjectile> p_36826_, LivingEntity p_36827_, double p_36828_, double p_36829_, double p_36830_, Level p_36831_) {
    ...
    public void tick() {
        ...
        if(this.lifeTicks%3==0){
            ...
            FireStormEntity e = new FireStormEntity(EntityInit.FIRE_STORM_CHILD.get(), pos.x+1.5*(r.nextFloat()-0.5),pos.y,pos.z+1.5*(r.nextFloat()-0.5), this.level());
            //e.yPower=-1.0f;
