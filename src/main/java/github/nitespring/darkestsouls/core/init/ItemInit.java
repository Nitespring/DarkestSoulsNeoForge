...
public class ItemInit {
	...
	public static final DeferredHolder<Item,Bloodletter> BLOODLETTER = ITEMS.register("bloodletter",
			() -> new Bloodletter(Tiers.TITANITE, 7.0f, 1.5f, 3.0f,0.4f, 6,8, 0,0,0,0,0,0,0,1,1350,15,0.11f, -1,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,BloodletterExtended> BLOODLETTER_EXTENDED = ITEMS.register("bloodletter_extended",
			() -> new BloodletterExtended(Tiers.TITANITE, 8.5f, 1.2f, 3.75f,0.6f, 8,12,3,0,0,0,0,0,0, 2,1350,15,0.11f, 2,new Item.Properties().rarity(Rarity.RARE)));
	...
	public static final DeferredHolder<Item,Zweihander> ASTORA_GREATSWORD = ITEMS.register("astora_greatsword",
			() -> new Zweihander(Tiers.TITANITE, 10.5f, 1.0f, 4.0f,0.8f, 9,14, 0,0,0,0,0,0,0,0,1024,15,0.07f, 5,new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> SIDERITE_BRICK_SLAB = ITEMS.register("siderite_brick_slab",
			() -> new BlockItem(BlockInit.SIDERITE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SIDERITE_BRICK_STAIRS = ITEMS.register("siderite_brick_stairs",
			() -> new BlockItem(BlockInit.SIDERITE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SIDERITE_BRICK_WALL = ITEMS.register("siderite_brick_wall",
			() -> new BlockItem(BlockInit.SIDERITE_BRICK_WALL.get(),new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_STONE_BRICK_SLAB = ITEMS.register("nightmare_stone_brick_slab",
			() -> new BlockItem(BlockInit.NIGHTMARE_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_STONE_BRICK_STAIRS = ITEMS.register("nightmare_stone_brick_stairs",
			() -> new BlockItem(BlockInit.NIGHTMARE_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_STONE_BRICK_WALL = ITEMS.register("nightmare_stone_brick_wall",
			() -> new BlockItem(BlockInit.NIGHTMARE_STONE_BRICK_WALL.get(),new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE_BRICK_SLAB = ITEMS.register("nightmare_smooth_stone_brick_slab",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE_BRICK_STAIRS = ITEMS.register("nightmare_smooth_stone_brick_stairs",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE_BRICK_WALL = ITEMS.register("nightmare_smooth_stone_brick_wall",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE_BRICK_WALL.get(),new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_STONE_BRICK_SLAB = ITEMS.register("dark_nightmare_stone_brick_slab",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_STONE_BRICK_STAIRS = ITEMS.register("dark_nightmare_stone_brick_stairs",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_STONE_BRICK_WALL = ITEMS.register("dark_nightmare_stone_brick_wall",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_STONE_BRICK_WALL.get(),new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE_BRICK_SLAB = ITEMS.register("dark_nightmare_smooth_stone_brick_slab",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE_BRICK_STAIRS = ITEMS.register("dark_nightmare_smooth_stone_brick_stairs",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE_BRICK_WALL = ITEMS.register("dark_nightmare_smooth_stone_brick_wall",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE_BRICK_WALL.get(),new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> RAW_STONE_BRICK_SLAB = ITEMS.register("raw_stone_brick_slab",
			() -> new BlockItem(BlockInit.RAW_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> RAW_STONE_BRICK_STAIRS = ITEMS.register("raw_stone_brick_stairs",
			() -> new BlockItem(BlockInit.RAW_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> RAW_STONE_BRICK_WALL = ITEMS.register("raw_stone_brick_wall",
			() -> new BlockItem(BlockInit.RAW_STONE_BRICK_WALL.get(),new Item.Properties()));
	...
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE = ITEMS.register("loran_sandstone",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_ORNATED_BRICKS = ITEMS.register("loran_sandstone_ornated_bricks",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_ORNATED_BRICKS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_DECOR_HUNTER = ITEMS.register("loran_sandstone_decor_hunter",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_DECOR_HUNTER.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE = ITEMS.register("loran_smooth_sandstone",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_COBBLESTONE = ITEMS.register("loran_sandstone_cobblestone",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_COBBLESTONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_BRICKS = ITEMS.register("loran_sandstone_bricks",
	...
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_TILES = ITEMS.register("loran_sandstone_tiles",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_TILES.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_TILES = ITEMS.register("light_loran_sandstone_tiles",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_TILES.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_TILES = ITEMS.register("loran_smooth_sandstone_tiles",
	...
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_STAIRS = ITEMS.register("loran_smooth_sandstone_stairs",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_COBBLESTONE_STAIRS = ITEMS.register("loran_sandstone_cobblestone_stairs",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_COBBLESTONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_BRICK_STAIRS = ITEMS.register("loran_sandstone_brick_stairs",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_BRICK_STAIRS = ITEMS.register("loran_smooth_sandstone_brick_stairs",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_STAIRS = ITEMS.register("light_loran_sandstone_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_STAIRS = ITEMS.register("light_loran_smooth_sandstone_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_COBBLESTONE_STAIRS = ITEMS.register("light_loran_sandstone_cobblestone_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_BRICK_STAIRS = ITEMS.register("light_loran_sandstone_brick_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_BRICK_STAIRS = ITEMS.register("light_loran_smooth_sandstone_brick_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_TILES_STAIRS = ITEMS.register("loran_sandstone_tiles_stairs",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_TILES_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_TILES_STAIRS = ITEMS.register("loran_smooth_sandstone_tiles_stairs",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_TILES_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_TILES_STAIRS = ITEMS.register("light_loran_sandstone_tiles_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_TILES_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_TILES_STAIRS = ITEMS.register("light_loran_smooth_sandstone_tiles_stairs",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_TILES_STAIRS.get(),new Item.Properties()));


	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_SLAB = ITEMS.register("loran_sandstone_slab",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_SLAB = ITEMS.register("loran_smooth_sandstone_slab",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_COBBLESTONE_SLAB = ITEMS.register("loran_sandstone_cobblestone_slab",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_COBBLESTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_BRICK_SLAB = ITEMS.register("loran_sandstone_brick_slab",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_BRICK_SLAB = ITEMS.register("loran_smooth_sandstone_brick_slab",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_SLAB = ITEMS.register("light_loran_sandstone_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_SLAB = ITEMS.register("light_loran_smooth_sandstone_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_COBBLESTONE_SLAB = ITEMS.register("light_loran_sandstone_cobblestone_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_BRICK_SLAB = ITEMS.register("light_loran_sandstone_brick_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_BRICK_SLAB = ITEMS.register("light_loran_smooth_sandstone_brick_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_TILES_SLAB = ITEMS.register("loran_sandstone_tiles_slab",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_TILES_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_TILES_SLAB = ITEMS.register("loran_smooth_sandstone_tiles_slab",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_TILES_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_TILES_SLAB = ITEMS.register("light_loran_sandstone_tiles_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_TILES_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_TILES_SLAB = ITEMS.register("light_loran_smooth_sandstone_tiles_slab",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_TILES_SLAB.get(),new Item.Properties()));

	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_WALL = ITEMS.register("loran_sandstone_wall",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_WALL = ITEMS.register("loran_smooth_sandstone_wall",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_COBBLESTONE_WALL = ITEMS.register("loran_sandstone_cobblestone_wall",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_COBBLESTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_BRICK_WALL = ITEMS.register("loran_sandstone_brick_wall",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_BRICK_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_BRICK_WALL = ITEMS.register("loran_smooth_sandstone_brick_wall",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_BRICK_WALL.get(),new Item.Properties()));
	static final DeferredHolder<Item,BlockItem> LORAN_SANDSTONE_TILES_WALL = ITEMS.register("loran_sandstone_tiles_wall",
			() -> new BlockItem(BlockInit.LORAN_SANDSTONE_TILES_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LORAN_SMOOTH_SANDSTONE_TILES_WALL = ITEMS.register("loran_smooth_sandstone_tiles_wall",
			() -> new BlockItem(BlockInit.LORAN_SMOOTH_SANDSTONE_TILES_WALL.get(),new Item.Properties()));

	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_WALL = ITEMS.register("light_loran_sandstone_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_WALL = ITEMS.register("light_loran_smooth_sandstone_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_COBBLESTONE_WALL = ITEMS.register("light_loran_sandstone_cobblestone_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_BRICK_WALL = ITEMS.register("light_loran_sandstone_brick_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_BRICK_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_BRICK_WALL = ITEMS.register("light_loran_smooth_sandstone_brick_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_BRICK_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SANDSTONE_TILES_WALL = ITEMS.register("light_loran_sandstone_tiles_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SANDSTONE_TILES_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> LIGHT_LORAN_SMOOTH_SANDSTONE_TILES_WALL = ITEMS.register("light_loran_smooth_sandstone_tiles_wall",
			() -> new BlockItem(BlockInit.LIGHT_LORAN_SMOOTH_SANDSTONE_TILES_WALL.get(),new Item.Properties()));


	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLESTONE = ITEMS.register("nightmare_cobblestone",
			() -> new BlockItem(BlockInit.NIGHTMARE_COBBLESTONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLESTONE_SLAB = ITEMS.register("nightmare_cobblestone_slab",
			() -> new BlockItem(BlockInit.NIGHTMARE_COBBLESTONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLESTONE_STAIRS = ITEMS.register("nightmare_cobblestone_stairs",
			() -> new BlockItem(BlockInit.NIGHTMARE_COBBLESTONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLESTONE_WALL = ITEMS.register("nightmare_cobblestone_wall",
			() -> new BlockItem(BlockInit.NIGHTMARE_COBBLESTONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLED_STONE_BRICKS = ITEMS.register("nightmare_cobbled_stone_bricks",
			() -> new BlockItem(BlockInit.NIGHTMARE_COBBLED_STONE_BRICKS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLED_STONE_BRICK_SLAB = ITEMS.register("nightmare_cobbled_stone_brick_slab",
			() -> new BlockItem(BlockInit.NIGHTMARE_COBBLED_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_COBBLED_STONE_BRICK_STAIRS = ITEMS.register("nightmare_cobbled_stone_brick_stairs",
	...
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_SLAB = ITEMS.register("smooth_chaos_stone_slab",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_BRICK_SLAB = ITEMS.register("chaos_stone_brick_slab",
			() -> new BlockItem(BlockInit.CHAOS_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_TILES_SLAB = ITEMS.register("chaos_stone_tiles_slab",
			() -> new BlockItem(BlockInit.CHAOS_STONE_TILES_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_BRICK_SLAB = ITEMS.register("smooth_chaos_stone_brick_slab",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_BRICK_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_TILES_SLAB = ITEMS.register("smooth_chaos_stone_tiles_slab",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_TILES_SLAB.get(),new Item.Properties()));

	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_STAIRS = ITEMS.register("chaos_stone_stairs",
			() -> new BlockItem(BlockInit.CHAOS_STONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_STAIRS = ITEMS.register("smooth_chaos_stone_stairs",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_BRICK_STAIRS = ITEMS.register("chaos_stone_brick_stairs",
			() -> new BlockItem(BlockInit.CHAOS_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_TILES_STAIRS = ITEMS.register("chaos_stone_tiles_stairs",
			() -> new BlockItem(BlockInit.CHAOS_STONE_TILES_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_BRICK_STAIRS = ITEMS.register("smooth_chaos_stone_brick_stairs",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_BRICK_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_TILES_STAIRS = ITEMS.register("smooth_chaos_stone_tiles_stairs",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_TILES_STAIRS.get(),new Item.Properties()));

	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_WALL = ITEMS.register("chaos_stone_wall",
			() -> new BlockItem(BlockInit.CHAOS_STONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_WALL = ITEMS.register("smooth_chaos_stone_wall",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_BRICK_WALL = ITEMS.register("chaos_stone_brick_wall",
			() -> new BlockItem(BlockInit.CHAOS_STONE_BRICK_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> CHAOS_STONE_TILES_WALL = ITEMS.register("chaos_stone_tiles_wall",
			() -> new BlockItem(BlockInit.CHAOS_STONE_TILES_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_BRICK_WALL = ITEMS.register("smooth_chaos_stone_brick_wall",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_BRICK_WALL.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> SMOOTH_CHAOS_STONE_TILES_WALL = ITEMS.register("smooth_chaos_stone_tiles_wall",
			() -> new BlockItem(BlockInit.SMOOTH_CHAOS_STONE_TILES_WALL.get(),new Item.Properties()));

	public static final DeferredHolder<Item,BlockItem> DEEPSTONE = ITEMS.register("deepstone",
			() -> new BlockItem(BlockInit.DEEPSTONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> GRIMSTONE = ITEMS.register("grimstone",
			() -> new BlockItem(BlockInit.GRIMSTONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DEEPSTONE_BRICKS = ITEMS.register("deepstone_bricks",
			() -> new BlockItem(BlockInit.DEEPSTONE_BRICKS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> GRIMSTONE_BRICKS = ITEMS.register("grimstone_bricks",
			() -> new BlockItem(BlockInit.GRIMSTONE_BRICKS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DEEPSTONE_TILES = ITEMS.register("deepstone_tiles",
	...
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE = ITEMS.register("nightmare_smooth_stone",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE_SLAB = ITEMS.register("nightmare_smooth_stone_slab",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE_STAIRS = ITEMS.register("nightmare_smooth_stone_stairs",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> NIGHTMARE_SMOOTH_STONE_WALL = ITEMS.register("nightmare_smooth_stone_wall",
			() -> new BlockItem(BlockInit.NIGHTMARE_SMOOTH_STONE_WALL.get(),new Item.Properties()));

	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE = ITEMS.register("dark_nightmare_smooth_stone",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE_SLAB = ITEMS.register("dark_nightmare_smooth_stone_slab",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE_SLAB.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE_STAIRS = ITEMS.register("dark_nightmare_smooth_stone_stairs",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE_STAIRS.get(),new Item.Properties()));
	public static final DeferredHolder<Item,BlockItem> DARK_NIGHTMARE_SMOOTH_STONE_WALL = ITEMS.register("dark_nightmare_smooth_stone_wall",
			() -> new BlockItem(BlockInit.DARK_NIGHTMARE_SMOOTH_STONE_WALL.get(),new Item.Properties()));
