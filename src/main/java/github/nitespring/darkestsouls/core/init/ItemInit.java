...
public class ItemInit {
	...
	public static final Supplier<FrayedBlade> FRAYED_BLADE = ITEMS.register("frayed_blade",
			() -> new FrayedBlade(Tiers.TITANITE, 8.0f, 1.6f, 3.5f,0.1f, 8, 3,0,0,0,0,0,0,1350,12,0.11f,-1, new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredHolder<Item, ShadowBlade> SHADOW_BLADE = ITEMS.register("shadow_blade",
			() -> new ShadowBlade(Tiers.TITANITE, 8.0f, 1.6f,3.5f, 0.2f, 8,1,0,0,0,0,1,0, 1350,15,0.11f, 2,new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredHolder<Item,DragonslayerSpear> DRAGONSLAYER_SPEAR = ITEMS.register("dragonslayer_spear",
			() -> new DragonslayerSpear(Tiers.TITANITE, 6.0f, 2.0f, 4.25f, -0.1f,5, 0,0,0,0,0,0,0, 1350,10,0.15f, -1,new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredHolder<Item,Weapon> DRAGONSLAYER_SWORDSPEAR = ITEMS.register("dragonslayer_swordspear",
			() -> new DragonslayerSwordspear(Tiers.TITANITE, 7.0f, 1.8f,4.0f, 0.1f, 7, 0,0,0,0,0,0,0,1350,10,0.12f, 2,new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredHolder<Item,StormCurvedSword> STORM_CURVED_SWORD = ITEMS.register("storm_curved_sword",
			() -> new StormCurvedSword(Tiers.TITANITE, 6.0f, 2.1f, 2.75f,0.1f, 5, 0,0,0,0,0,0,0, 1350,10,0.14f, 2,new Item.Properties().rarity(Rarity.EPIC)));
	public static final DeferredHolder<Item,DragonslayerGreataxe> DRAGONSLAYER_GREATAXE = ITEMS.register("dragonslayer_greataxe",
			() -> new DragonslayerGreataxe(Tiers.TITANITE, 10.0f, 1.0f, 3.5f,0.4f, 10, 0,0,0,0,0,0,0,225,8,0.07f, 3,new Item.Properties()));
	//Trick Weapons
	public static final DeferredHolder<Item,SawCleaver> SAW_CLEAVER = ITEMS.register("saw_cleaver",
			() -> new SawCleaver(Tiers.TITANITE, 6.0f, 1.7f, 3.0f,0.1f, 6, 0,0,0,0,0,0,0,1350,15,0.108f, 2,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,SawCleaverExtended> SAW_CLEAVER_EXTENDED = ITEMS.register("saw_cleaver_extended",
			() -> new SawCleaverExtended(Tiers.TITANITE, 7.5f, 1.5f,3.5f, 0.2f, 8, 0,0,0,0,0,0,0,1350,15,0.104f, 3,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,HunterAxe> HUNTER_AXE = ITEMS.register("hunter_axe",
			() -> new HunterAxe(Tiers.TITANITE, 7.0f, 1.4f, 3.0f,0.4f, 8, 0,0,0,0,0,0,0,1350,15,0.11f, 2,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,HunterAxeExtended> HUNTER_AXE_EXTENDED = ITEMS.register("hunter_axe_extended",
			() -> new HunterAxeExtended(Tiers.TITANITE, 8.0f, 1.2f, 3.75f,0.6f, 12,0,0,0,0,0,0,0, 1350,15,0.11f, 3,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,Chikage> CHIKAGE = ITEMS.register("chikage",
			() -> new Chikage(Tiers.TITANITE, 6.0f, 1.9f, 3.5f,0.1f, 5,1,0,0,0,0,0,0, 1350,15,0.12f, 2,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,ChikageExtended> CHIKAGE_EXTENDED = ITEMS.register("chikage_extended",
			() -> new ChikageExtended(Tiers.TITANITE, 12.0f, 1.7f,3.7f, 0.3f, 8,4,0,0,0,0,0,0, 1350,15,0.112f, 2,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,HolyMoonlightSword> HOLY_MOONLIGHT = ITEMS.register("holy_moonlight_sword",
			() -> new HolyMoonlightSword(Tiers.TITANITE, 7.0f, 1.4f,3.6f, 0.2f, 6, 0,0,0,0,0,0,0,1350,17,0.1f, 3,new Item.Properties().rarity(Rarity.RARE)));
	public static final DeferredHolder<Item,HolyMoonlightSwordLit> HOLY_MOONLIGHT_LIT = ITEMS.register("holy_moonlight_sword_lit",
			() -> new HolyMoonlightSwordLit(Tiers.TITANITE, 8.0f, 1.2f, 3.75f,0.2f, 6, 0,0,0,0,0,0,0,1350,17,0.1f, -1,new Item.Properties().rarity(Rarity.RARE)));

	public static final DeferredHolder<Item,BrokenStraightsword> BROKEN_STRAIGHTSWORD = ITEMS.register("broken_straightsword",
			() -> new BrokenStraightsword(Tiers.TITANITE, 3.0f, 1.6f,1.75f, 0.0f, 2, 0,0,0,0,0,0,0,127,8,0.1f, 1,new Item.Properties()));
	public static final DeferredHolder<Item,BanditKnife> BANDIT_KNIFE = ITEMS.register("bandit_knife",
			() -> new BanditKnife(Tiers.TITANITE, 3.0f, 2.4f, 2.25f,0.0f, 2, 3,0,0,0,0,0,0,63,6,0.18f, 1,new Item.Properties()));
	public static final DeferredHolder<Item,Longsword> LONGSWORD = ITEMS.register("longsword",
			() -> new Longsword(Tiers.TITANITE, 7.0f, 1.6f, 3.25f,0.0f, 6, 0,0,0,0,0,0,0,225,8,0.1f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,DarkSword> DARKSWORD = ITEMS.register("dark_sword",
			() -> new DarkSword(Tiers.TITANITE, 7.5f, 1.5f, 3.0f,0.05f, 6, 0,0,0,0,0,0,0,1024,10,0.0975f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Scimitar> SCIMITAR = ITEMS.register("scimitar",
			() -> new Scimitar(Tiers.TITANITE, 5.0f, 1.9f,3.0f, -0.2f, 4, 0,0,0,0,0,0,0,225,8,0.14f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Falchion> FALCHION = ITEMS.register("falchion",
			() -> new Falchion(Tiers.TITANITE, 6.0f, 1.7f,3.2f, -0.1f, 5,0,0,0,0,0,0,0, 275,7,0.13f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Shotel> SHOTEL = ITEMS.register("shotel",
			() -> new Shotel(Tiers.TITANITE, 5.5f, 1.8f,3.0f, -0.2f, 4,0,0,0,0,0,0,0, 275,7,0.14f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Shotel> CARTHUS_SHOTEL = ITEMS.register("carthus_shotel",
			() -> new Shotel(Tiers.TITANITE, 5.5f, 1.8f,3.1f, -0.2f, 5, 1,0,0,0,0,0,0,275,7,0.14f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,CurvedGreatsword> CARTHUS_CURVED_GREATSWORD= ITEMS.register("carthus_curved_greatsword",
			() -> new CurvedGreatsword(Tiers.TITANITE, 7.0f, 1.6f,3.75f, 0.2f, 7, 2,0,0,0,0,0,0,225,8,0.105f, 5,new Item.Properties()));
	public static final DeferredHolder<Item,Claymore> CLAYMORE = ITEMS.register("claymore",
			() -> new Claymore(Tiers.TITANITE, 9.0f, 1.2f, 3.6f, 0.4f, 12,0,0,0,0,0,0,0, 500,7,0.09f, 3,new Item.Properties()));
	public static final DeferredHolder<Item,Flamberge> FLAMBERGE = ITEMS.register("flamberge",
			() -> new Flamberge(Tiers.TITANITE, 8.5f, 1.2f, 3.6f,0.3f, 11,4, 0,0,0,0,0,0,400,6,0.09f, 3,new Item.Properties()));
	public static final DeferredHolder<Item,Zweihander> ZWEIHANDER = ITEMS.register("zweihander",
			() -> new Zweihander(Tiers.TITANITE, 10.5f, 1.0f, 4.0f,0.8f, 14, 0,0,0,0,0,0,0,1024,15,0.07f, 5,new Item.Properties()));
	public static final DeferredHolder<Item,Scimitar> BANDIT_CURVED_SWORD = ITEMS.register("bandit_curved_sword",
			() -> new Scimitar(Tiers.TITANITE, 6.0f, 1.6f, 3.15f,-0.2f, 4, 0,0,0,0,0,0,0,250,8,0.14f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Spear> SPEAR = ITEMS.register("spear",
			() -> new Spear(Tiers.TITANITE, 5.0f, 2.0f,4.5f, -0.1f, 4, 0,0,0,0,0,0,0,1350,10,0.13f, 1,new Item.Properties()));
	public static final DeferredHolder<Item,GraveScythe> GRAVE_SCYTHE= ITEMS.register("grave_scythe",
			() -> new GraveScythe(Tiers.TITANITE, 7.0f, 1.6f,4.6f, 0.2f, 7, 2,0,0,0,0,0,0,225,8,0.105f, 5,new Item.Properties()));
	public static final DeferredHolder<Item,Uchigatana> UCHIGATANA = ITEMS.register("uchigatana",
			() -> new Uchigatana(Tiers.TITANITE, 6.0f, 1.7f,3.5f, 0.1f, 5,2,0,0,0,0,0,0, 200,15,0.11f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Weapon> BATTLE_AXE = ITEMS.register("battle_axe",
			() -> new Axe(Tiers.TITANITE, 6.0f, 1.4f,3.0f, 0.1f, 6, 0,0,0,0,0,0,0,225,8,0.09f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Greataxe> EXECUTIONER_GREATAXE = ITEMS.register("executioner_greataxe",
			() -> new Greataxe(Tiers.TITANITE, 10.0f, 1.0f, 4.0f,0.4f, 10, 0,0,0,0,0,0,0,225,8,0.07f, 3,new Item.Properties()));
	public static final DeferredHolder<Item,Greataxe> CRESCENT_MOON_GREATAXE = ITEMS.register("crescent_moon_greataxe",
			() -> new Greataxe(Tiers.TITANITE, 9.0f, 1.2f, 4.25f,0.4f, 10, 0,0,0,0,0,0,0,225,8,0.08f, 3,new Item.Properties()));
	...
	public static final DeferredHolder<Item,Scimitar> HUNTSMAN_CUTLASS = ITEMS.register("huntsman_cutlass",
			() -> new Scimitar(Tiers.TITANITE, 5.0f, 1.9f,3.0f, -0.2f, 4, 0,0,0,0,0,0,0,225,8,0.11f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,Weapon> HUNTSMAN_PITCHFORK = ITEMS.register("huntsman_pitchfork",
			() -> new Spear(Tiers.TITANITE, 5.0f, 1.9f,3.8f, -0.2f, 4, 225,0,0,0,0,0,0,0,8,0.12f, 2,new Item.Properties()));
	public static final DeferredHolder<Item,ChurchScythe> CHURCH_SCYTHE= ITEMS.register("church_scythe",
			() -> new ChurchScythe(Tiers.TITANITE, 7.5f, 1.6f,4.5f, 0.2f, 7, 0,0,0,0,0,0,1,325,12,0.105f, 5,new Item.Properties()));
	public static final DeferredHolder<Item,Weapon> CHURCH_CANE = ITEMS.register("church_cane",
			() -> new Weapon(Tiers.TITANITE, 4.0f, 1.4f, 2.5f,0.1f, 6, 0,0,0,0,0,0,0,255,8,0.1f, 0,new Item.Properties()));
	public static final DeferredHolder<Item,Spear> CRUCIFIX = ITEMS.register("crucifix",
			() -> new Spear(Tiers.TITANITE, 6.0f, 1.2f,4.0f, 0.2f, 6, 0,0,0,0,1, 0,1,1350,10,0.08f, 2,new Item.Properties()));
	//Staves
	...
	public static final DeferredHolder<Item,Weapon> HUNTER_TORCH= ITEMS.register("hunter_torch",
			() -> new Weapon(Tiers.TITANITE, 1.0f, 1.9f, 2.5f,-0.2f, 4, 0,0,0,0,0,2,0,225,8,0.10f, 2,new Item.Properties()));
