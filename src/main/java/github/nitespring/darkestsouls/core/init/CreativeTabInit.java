    ...
    public static final DeferredHolder<CreativeModeTab,CreativeModeTab> EQUIPMENT =   TABS.register("equipment",
            () ->CreativeModeTab.builder()
                    ...
                    .withSearchBar().displayItems((displayParams,output)->{
                        ...
                        output.accept(ItemInit.CRYSTALIAN_SMALL_CHAKRAM.get());
                        ...
                        output.accept(ItemInit.DEMON_GREAT_MACHETE.get());
                        output.accept(ItemInit.SPEAR.get());
                        output.accept(ItemInit.CRYSTALIAN_SPEAR.get());
    ...
    public static final DeferredHolder<CreativeModeTab,CreativeModeTab> MOBS = TABS.register("mobs",
            () ->CreativeModeTab.builder()
                    ...
                    .withSearchBar().displayItems((displayParams,output)->{
                        ...
                        output.accept(ItemInit.LARGE_SPIDER.get());
                        output.accept(ItemInit.NIGHTMARE_APOSTLE.get());
                        output.accept(ItemInit.LARGE_NIGHTMARE_APOSTLE.get());
    ...
    public static final DeferredHolder<CreativeModeTab,CreativeModeTab> BLOCKS = TABS.register("blocks",
            () ->CreativeModeTab.builder()
                    ...
                    .withSearchBar().displayItems((displayParams,output)->{
                        ...
                        output.accept(ItemInit.NIGHTMARE_COBBLESTONE_WALL.get());
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICKS.get());
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICK_SLAB.get());
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICK_STAIRS.get());
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICK_WALL.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICKS.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICK_SLAB.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICK_STAIRS.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICK_WALL.get());
                        output.accept(ItemInit.NIGHTMARE_COBBLED_STONE_BRICKS.get());
                        output.accept(ItemInit.NIGHTMARE_COBBLED_STONE_BRICK_SLAB.get());
                        ...
                        output.accept(ItemInit.DARK_NIGHTMARE_STONE_BRICK_WALL.get());
                        output.accept(ItemInit.DARK_NIGHTMARE_SMOOTH_STONE_BRICKS.get());
                        ...
                        output.accept(ItemInit.RAW_STONE_BRICK_SLAB.get());
                        output.accept(ItemInit.RAW_STONE_BRICK_STAIRS.get());
                        output.accept(ItemInit.RAW_STONE_BRICK_WALL.get());
                        ...
                        output.accept(ItemInit.LIGHT_LORAN_SANDSTONE_STAIRS.get());
                        output.accept(ItemInit.LIGHT_LORAN_SANDSTONE_WALL.get());
                        ...
                        output.accept(ItemInit.LIGHT_LORAN_SMOOTH_SANDSTONE_SLAB.get());
                        output.accept(ItemInit.LIGHT_LORAN_SMOOTH_SANDSTONE_STAIRS.get());
                        output.accept(ItemInit.LIGHT_LORAN_SMOOTH_SANDSTONE_WALL.get());
                        output.accept(ItemInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE.get());
                        output.accept(ItemInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE_SLAB.get());
                        output.accept(ItemInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE_STAIRS.get());
                        output.accept(ItemInit.LIGHT_LORAN_SANDSTONE_COBBLESTONE_WALL.get());
                        ...
                        output.accept(ItemInit.CHAOS_STONE_WALL.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_SLAB.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_STAIRS.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_WALL.get());
                        ...
                        output.accept(ItemInit.CHAOS_STONE_TILES_WALL.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_BRICKS.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_BRICK_SLAB.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_BRICK_STAIRS.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_BRICK_WALL.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_TILES.get());
                        output.accept(ItemInit.SMOOTH_CHAOS_STONE_TILES_SLAB.get());
