    ...
    public static final DeferredHolder<CreativeModeTab,CreativeModeTab> BLOCKS = TABS.register("blocks",
            () ->CreativeModeTab.builder()
                    ...
                    .withSearchBar().displayItems((displayParams,output)->{
                        ...
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICKS_SLAB.get());
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICKS_STAIRS.get());
                        output.accept(ItemInit.NIGHTMARE_STONE_BRICKS_WALL.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICKS.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICKS_SLAB.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICKS_STAIRS.get());
                        output.accept(ItemInit.NIGHTMARE_SMOOTH_STONE_BRICKS_WALL.get());
                        ...
                        output.accept(ItemInit.DARK_NIGHTMARE_STONE_BRICKS_SLAB.get());
                        output.accept(ItemInit.DARK_NIGHTMARE_STONE_BRICKS_STAIRS.get());
                        output.accept(ItemInit.DARK_NIGHTMARE_STONE_BRICKS_WALL.get());
